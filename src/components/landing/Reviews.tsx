          ...
          {REVIEWS.map((r) => (
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <span className="rounded-full border border-cosmic-500/30 bg-cosmic-500/10 px-2.5 py-0.5 text-xs text-cosmic-300">
                  {r.plan}
                </span>
              </div>
            </div>
